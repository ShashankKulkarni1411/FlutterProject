          ...
          builder: (context, constraints) {
            return SingleChildScrollView(
              padding: EdgeInsets.only(
                ...
                right: 20,
                top: 20,
                bottom: MediaQuery.of(context).padding.bottom + 90, // Footer height + safe area
              ),
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  minHeight: constraints.maxHeight - MediaQuery.of(context).padding.top - 90,
                ),
                child: Column(
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final itemWidth = (screenWidth - 52) / 2; // Accounting for padding and spacing
                  return Wrap(
                    spacing: 12,
                    runSpacing: 12,
                    children: [
      ...
      body: SafeArea(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, userSnapshot) {
            ...
            final spentThisMonth = (userData?['spentThisMonth'] ?? 12500).toDouble();
